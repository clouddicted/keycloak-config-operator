...
| --- | --- | --- | --- | --- |
| `0.4.0` | `26.6.2` | Supported | PR, branch, tag, and manual kind e2e | Default `KEYCLOAK_VERSION`. |
| `0.4.0` | `26.5.3` | Compatibility tested | Tag and manual kind e2e | Previous-minor smoke coverage. |
| `0.4.0` | `<26.5` | Unsupported | Not tested | Upgrade Keycloak or validate locally before use. |
