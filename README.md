...
roles, groups, group role mappings, realm roles, client scopes, protocol
mappers, and target connections in a GitOps-friendly way.
...
The `v0.6.0` release serves Keycloak resources as `keycloak.clouddicted.com/v1beta1`.
...
`ghcr.io/clouddicted/keycloak-config-operator:v0.6.0`. For local testing, replace it
