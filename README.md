...
The `v0.7.0` release serves Keycloak resources as `keycloak.clouddicted.com/v1beta1`.
...
`ghcr.io/clouddicted/keycloak-config-operator:v0.7.0`. For local testing, replace it
